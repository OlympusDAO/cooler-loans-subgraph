...
export class MonoCooler__accountDelegationsListResultDelegationsStruct extends ethereum.Tuple {
...
export class MonoCooler__accountPositionResultPositionStruct extends ethereum.Tuple {
...
export class MonoCooler__accountStateResultValue0Struct extends ethereum.Tuple {
  get collateral(): BigInt {
    return this[0].toBigInt();
  }
...
export class MonoCooler__applyDelegationsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class MonoCooler__applyDelegationsInputDelegationRequestsStruct extends ethereum.Tuple {
  get delegate(): Address {
    return this[0].toAddress();
  }
...
export class MonoCooler__applyUnhealthyDelegationsResult {
  value0: BigInt;
  value1: BigInt;
...
export class MonoCooler__batchLiquidateResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class MonoCooler__checkpointDebtResult {
  value0: BigInt;
  value1: BigInt;
...
export class MonoCooler__computeLiquidityResultStatusStruct extends ethereum.Tuple {
  get collateral(): BigInt {
    return this[0].toBigInt();
  }
...
export class MonoCooler__globalStateResult {
  value0: BigInt;
  value1: BigInt;
...
export class MonoCooler__loanToValuesResult {
  value0: BigInt;
  value1: BigInt;
...
export class MonoCooler__requestPermissionsResultRequestsStruct extends ethereum.Tuple {
  get keycode(): Bytes {
...
export class MonoCooler__withdrawCollateralInputDelegationRequestsStruct extends ethereum.Tuple {
  get delegate(): Address {
    return this[0].toAddress();
  }
...
export class MonoCooler extends ethereum.SmartContract {
  static bind(address: Address): MonoCooler {
    return new MonoCooler("MonoCooler", address);
  }

  DLGTE(): Address {
    let result = super.call("DLGTE", "DLGTE():(address)", []);

    return result[0].toAddress();
  }

  try_DLGTE(): ethereum.CallResult<Address> {
    let result = super.tryCall("DLGTE", "DLGTE():(address)", []);
    if (result.reverted) {
  ...
  accountDebt(account: Address): BigInt {
    let result = super.call("accountDebt", "accountDebt(address):(uint128)", [
      ethereum.Value.fromAddress(account),
    ]);
  ...
  accountDelegationsList(
    ...
    startIndex: BigInt,
    maxItems: BigInt,
  ): Array<MonoCooler__accountDelegationsListResultDelegationsStruct> {
    let result = super.call(
      "accountDelegationsList",
    ...
    return result[0].toTupleArray<MonoCooler__accountDelegationsListResultDelegationsStruct>();
  }
  ...
  > {
    ...
    return ethereum.CallResult.fromValue(
      value[0].toTupleArray<MonoCooler__accountDelegationsListResultDelegationsStruct>(),
    );
  }

  accountPosition(
    account: Address,
  ): MonoCooler__accountPositionResultPositionStruct {
    let result = super.call(
      "accountPosition",
    ...
    return changetype<MonoCooler__accountPositionResultPositionStruct>(
      result[0].toTuple(),
    );
  }
  ...
  try_accountPosition(
    account: Address,
  ): ethereum.CallResult<MonoCooler__accountPositionResultPositionStruct> {
    let result = super.tryCall(
      "accountPosition",
      "accountPosition(address):((uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256))",
      [ethereum.Value.fromAddress(account)],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<MonoCooler__accountPositionResultPositionStruct>(
        value[0].toTuple(),
      ),
    );
  }

  accountState(account: Address): MonoCooler__accountStateResultValue0Struct {
    let result = super.call(
      "accountState",
    ...
    return changetype<MonoCooler__accountStateResultValue0Struct>(
      result[0].toTuple(),
    );
  }
  ...
  try_accountState(
    account: Address,
  ): ethereum.CallResult<MonoCooler__accountStateResultValue0Struct> {
    let result = super.tryCall(
      "accountState",
      "accountState(address):((uint128,uint128,uint256))",
      [ethereum.Value.fromAddress(account)],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<MonoCooler__accountStateResultValue0Struct>(
        value[0].toTuple(),
      ),
    );
  }
  ...
  applyDelegations(
    delegationRequests: Array<MonoCooler__applyDelegationsInputDelegationRequestsStruct>,
    onBehalfOf: Address,
  ): MonoCooler__applyDelegationsResult {
    let result = super.call(
      "applyDelegations",
    ...
    return new MonoCooler__applyDelegationsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
    );
  ...
  try_applyDelegations(
    delegationRequests: Array<MonoCooler__applyDelegationsInputDelegationRequestsStruct>,
    onBehalfOf: Address,
  ): ethereum.CallResult<MonoCooler__applyDelegationsResult> {
    let result = super.tryCall(
      "applyDelegations",
      "applyDelegations((address,int256)[],address):(uint256,uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new MonoCooler__applyDelegationsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
      ),
  ...
  applyUnhealthyDelegations(
  ...
  ): MonoCooler__applyUnhealthyDelegationsResult {
    let result = super.call(
      "applyUnhealthyDelegations",
    ...
    return new MonoCooler__applyUnhealthyDelegationsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }
  ...
  try_applyUnhealthyDelegations(
    account: Address,
    autoRescindMaxNumDelegates: BigInt,
  ): ethereum.CallResult<MonoCooler__applyUnhealthyDelegationsResult> {
    let result = super.tryCall(
      "applyUnhealthyDelegations",
      "applyUnhealthyDelegations(address,uint256):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new MonoCooler__applyUnhealthyDelegationsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
      ),
    );
  ...
  batchLiquidate(accounts: Array<Address>): MonoCooler__batchLiquidateResult {
    let result = super.call(
      "batchLiquidate",
    ...
    return new MonoCooler__batchLiquidateResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
    );
  ...
  try_batchLiquidate(
  ...
  ): ethereum.CallResult<MonoCooler__batchLiquidateResult> {
    let result = super.tryCall(
      "batchLiquidate",
      "batchLiquidate(address[]):(uint128,uint128,uint128)",
      [ethereum.Value.fromAddressArray(accounts)],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new MonoCooler__batchLiquidateResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
      ),
  ...
  borrowsPaused(): boolean {
    let result = super.call("borrowsPaused", "borrowsPaused():(bool)", []);

    return result[0].toBoolean();
  }

  try_borrowsPaused(): ethereum.CallResult<boolean> {
    let result = super.tryCall("borrowsPaused", "borrowsPaused():(bool)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  checkpointDebt(): MonoCooler__checkpointDebtResult {
    let result = super.call(
      "checkpointDebt",
    ...
    return new MonoCooler__checkpointDebtResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }

  try_checkpointDebt(): ethereum.CallResult<MonoCooler__checkpointDebtResult> {
    let result = super.tryCall(
      "checkpointDebt",
      "checkpointDebt():(uint128,uint256)",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new MonoCooler__checkpointDebtResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
      ),
    );
  ...
  computeLiquidity(
    accounts: Array<Address>,
  ): Array<MonoCooler__computeLiquidityResultStatusStruct> {
    let result = super.call(
      "computeLiquidity",
    ...
    return result[0].toTupleArray<MonoCooler__computeLiquidityResultStatusStruct>();
  }
  ...
  > {
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      value[0].toTupleArray<MonoCooler__computeLiquidityResultStatusStruct>(),
    );
  }
  ...
  globalState(): MonoCooler__globalStateResult {
    let result = super.call(
      "globalState",
    ...
    return new MonoCooler__globalStateResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }

  try_globalState(): ethereum.CallResult<MonoCooler__globalStateResult> {
    let result = super.tryCall(
      "globalState",
      "globalState():(uint128,uint256)",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new MonoCooler__globalStateResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
      ),
    );
  ...
  loanToValues(): MonoCooler__loanToValuesResult {
    let result = super.call(
      "loanToValues",
    ...
    return new MonoCooler__loanToValuesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }

  try_loanToValues(): ethereum.CallResult<MonoCooler__loanToValuesResult> {
    let result = super.tryCall(
      "loanToValues",
      "loanToValues():(uint96,uint96)",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new MonoCooler__loanToValuesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
      ),
    );
  ...
  ltvOracle(): Address {
    let result = super.call("ltvOracle", "ltvOracle():(address)", []);

    return result[0].toAddress();
  }

  try_ltvOracle(): ethereum.CallResult<Address> {
    let result = super.tryCall("ltvOracle", "ltvOracle():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  repay(repayAmount: BigInt, onBehalfOf: Address): BigInt {
    let result = super.call("repay", "repay(uint128,address):(uint128)", [
  ...
  try_repay(
    ...
    let result = super.tryCall("repay", "repay(uint128,address):(uint128)", [
      ethereum.Value.fromUnsignedBigInt(repayAmount),
      ethereum.Value.fromAddress(onBehalfOf),
    ]);
    if (result.reverted) {
  ...
  requestPermissions(): Array<MonoCooler__requestPermissionsResultRequestsStruct> {
    let result = super.call(
      "requestPermissions",
    ...
    return result[0].toTupleArray<MonoCooler__requestPermissionsResultRequestsStruct>();
  }

  try_requestPermissions(): ethereum.CallResult<
    Array<MonoCooler__requestPermissionsResultRequestsStruct>
  > {
    let result = super.tryCall(
      "requestPermissions",
      "requestPermissions():((bytes5,bytes4)[])",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      value[0].toTupleArray<MonoCooler__requestPermissionsResultRequestsStruct>(),
    );
  }
  ...
  totalDebt(): BigInt {
    let result = super.call("totalDebt", "totalDebt():(uint128)", []);

    return result[0].toBigInt();
  }

  try_totalDebt(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("totalDebt", "totalDebt():(uint128)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  withdrawCollateral(
    ...
    onBehalfOf: Address,
    recipient: Address,
    delegationRequests: Array<MonoCooler__withdrawCollateralInputDelegationRequestsStruct>,
  ): BigInt {
    let result = super.call(
      "withdrawCollateral",
